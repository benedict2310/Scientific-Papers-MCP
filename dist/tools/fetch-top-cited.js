 ...
 */
export async function fetchTopCited(input, rateLimiter) {
    try {
        ...
        const papers = await driver.fetchTopCited(input.concept, input.since, input.count);
...
//# sourceMappingURL=fetch-top-cited.js.map